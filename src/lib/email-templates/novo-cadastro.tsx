...
const NovoCadastroEmail = ({ nome, email, empresa }: Props) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Novo cadastro aguardando aprovação de acesso</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={banner}>
          <Text style={bannerText}>Sistema de Precificação de Fretes</Text>
        </Section>
        <Heading style={heading}>Novo cadastro para aprovar</Heading>
        <Text style={text}>
...
export const template = {
  ...
  subject: 'Novo cadastro para aprovar',
