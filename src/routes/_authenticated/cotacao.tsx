...
import { Check, ClipboardList, Eraser, LogOut, Plus, Save, Send, Settings, Trash2, UserCheck, X } from "lucide-react";
import {
  decidirAcesso,
  definirPerfil,
  excluirUsuario,
...
function Index() {
  ...
  // perfil salvo (mesma regra do backend); os demais usuários seguem a
  // role 'approver' em user_roles, editável por um administrador.
  ...
  const carregarSubmissao = (s: Submissao) => {
    ...
    setIdAtual(s.ref_local ?? undefined);
